...
cat("
    ...
    ##TODO##
    #put uniform of variance and then take 1/x
    ...
    car[1:326] ~ car.normal(adj[], weights[], num[], tau.car)
...
ni <- 100#100000 #Number of draws from posterior
nb <- 2#00 #Number of draws to discard as burn-in
nt <- 2#50 #Thinning rate
